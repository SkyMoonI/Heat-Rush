...
{
	const string privateCode = "qkA4IaFLjkS8k3YjAK5iXwerH1GZt9v0CfYMEqV3Wwow";  //Key to Upload New Info
	const string publicCode = "66a63d2d8f40bb11084dabee";   //Key to download
